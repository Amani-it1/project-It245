...
public class BookInquirySystemLinkedList {
...
switch (choice) {
	...
	public static void searchBook(LinkedList<Book> books) {
		Scanner input = new Scanner(System.in);
	...
	public static void deleteBook(LinkedList<Book> books) {
		Scanner input = new Scanner(System.in);
	...
	public static void displayBooks(LinkedList<Book> books) {
